...
public class UserStorageValidator {
	...
	@ServiceActivator(inputChannel = "user-registry-channel-3-validate-storage", 
			outputChannel = "user-registry-channel-4-service")
	...
	@ServiceActivator(inputChannel = "login-channel-3-validate-storage", 
			outputChannel = "login-channel-4-service")
